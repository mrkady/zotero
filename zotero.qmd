...
I am not going to give you the PDFs or even links to the articles this time—use what you learned in the last case to get the items into Zotero following your preferred method and get to annotating!
...
-   What happens when a PDF already has external annotations inside of it ([example PDF here](case3/Lazebnik, Nat Rev Cancer, 2010. What are the hallmarks of cancer.pdf))? Can you see them in Zotero? Can you edit them?
...
**Suggested Exercise:** Insert citation for the Hallmarks of Cancer paper from your Zotero library into a Microsoft Word document, using the *Nature* citation style.
:::
...
**Suggested Exercise:** Use my personal style and Quick Copy to insert a footnote for the Hallmarks of Cancer paper into PowerPoint.
:::
...
::: {.callout-note collapse="true"}
### Finding related papers with ResearchRabbit or Connected Papers (click to expand)

Sometimes when I'm trying to familiarize myself with a new large body of work, I feel like I am reading *around* a topic while missing important elements of it, or I want to know if any important follow-up work has been done since the articles I'm reading were published. Usually Google Scholar does the trick, but sometimes I'm too clueless to know what to search. There are a few apps which, when given a paper or papers as input, will generate network graphs of relatedness based on citations or keywords. This can help you fill in gaps in your library.

The one that I like the most is [ResearchRabbit](https://www.researchrabbit.ai/), which is free. You can create manual libraries or sync a library from Zotero of up to 100 items. ResearchRabbit will then map out *Similar Work*, *Earlier Work*, and *Later Work*, as well as connections between authors. There are lots of interesting features worth exploring.

There are a few apps that do similar things. [Connected Papers](https://www.connectedpapers.com/) is one, but the free version limits the number of graphs per month.

**Suggested Exercise:** Using the Hallmarks of Cancer paper as a starting point, using ResearchRabbit or Connected Papers to find a related paper and add it to your Zotero library.
:::
...
Usually, only the lead author manages the insertion of citations into a manuscript. However, you may have good reason to share a set of references with colleagues. There are of course many ways to do this, like sending a list of URLs or PMIDs, sending attached PDFs, etc. You can also [Zotero Groups](https://www.zotero.org/support/groups), which allows you to create publicly available and collaborative ***Group Libraries*** using references of your main library.
